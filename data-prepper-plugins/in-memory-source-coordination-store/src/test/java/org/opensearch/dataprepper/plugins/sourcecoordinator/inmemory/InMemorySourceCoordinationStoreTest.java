...
public class InMemorySourceCoordinationStoreTest {
    ...
    void tryUpdateSourcePartitionItem_calls_updateItem_of_InMemoryPartitionAccessor() {
        ...
        given(inMemoryPartitionAccessor.updateItem((InMemorySourcePartitionStoreItem) item)).willReturn(true);

        final boolean updated = createObjectUnderTest().tryUpdateSourcePartitionItem(item);
