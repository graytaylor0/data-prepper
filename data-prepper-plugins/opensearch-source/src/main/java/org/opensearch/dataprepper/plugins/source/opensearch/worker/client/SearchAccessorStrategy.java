...
public class SearchAccessorStrategy {
    ...
    public SearchAccessorStrategy(final OpenSearchSourceConfiguration openSearchSourceConfiguration,
    ...
    private void attachSigv4Auth(final RestClientBuilder restClientBuilder) {
        ...
        final HttpRequestInterceptor httpRequestInterceptor = awsHttpRequestInterceptorSupplier.getAwsRequestInterceptor(
                AwsHttpRequestInterceptorOptions.builder()
                        .withCredentialsProvider(awsCredentialsProvider)
                        .withRegion(openSearchSourceConfiguration.getAwsAuthenticationOptions().getAwsRegion())
                        .withSigner(Aws4Signer.create())
                        .withServiceName(AOS_SERVICE_NAME)
                        .build());
